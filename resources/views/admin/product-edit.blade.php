            ...
            <div class="wg-box">
                ...
                <div class="gap22 cols">
                    <fieldset class="category">
                        ...
                        <div class="select">
                            <select class="p-3 fs-4" name="category_id">
                    ...
                    <fieldset class="brand">
                        ...
                        <div class="select">
                            <select class="p-3 fs-4" name="brand_id">
                ...
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" aria-required="true" required="">{{$product->short_description}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                </fieldset>
                @error('description')
                    <span class="alert alert-danger text-center">{{$message}}</span>
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="p-3 fs-4" name="stock_status">
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="p-3 fs-4" name="featured">
